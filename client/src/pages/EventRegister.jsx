...
const EventRegister = () => {
    ...
    return (
        <div className='w-full h-full'>
            <div className='z-1000 bg-[url("./assets/eventsRegister.jpg")] w-full h-full bg-blend-multiply bg-[#0000006d] bg-fixed bg-no-repeat bg-cover'>
                            ...
                            <div className="flex w-1/2 md:w-full md:p-0 h-full justify-center flex-col  md:gap-0 md:h-full gap-10 items-center text-md text-white px-10 py-0 text-center">
                                <ConfigProvider
                                    ...
                                    >
                                        ...
                                        >
                                            <Input name='contactNo' placeholder='Contact No. of Leader' onChange={(e) => changeHandler(e.target.name, e.target.value)} value={Data.contactNo} className='bg-transparent placeholder:text-gray-300 hover:bg-transparent active:bg-transparent focus:bg-transparent text-white' />
                                        </Form.Item>
                                        ...
                                        >
                                            <Input name='contactNo2' placeholder='Contact No. of Member' onChange={(e) => changeHandler(e.target.name, e.target.value)} value={Data.contactNo2} className='bg-transparent placeholder:text-gray-300 hover:bg-transparent active:bg-transparent focus:bg-transparent text-white' />
                                        </Form.Item>
                                        ...
                                        >
                                            ...
                                            {Data.level === "college" ?
                                                (
                                                    <Select name='year' value={Data.year} onChange={changeHandler} type="text" placeholder='Level' >
...

                                        {
                                            Data.level === "college" ?
                                                <div>
                                                    ...
                                                    >
                                                        <Select className='placeholder:text-white ' placeholder="Select a Level" name="level" value={Data.ug_pg} onChange={(value) => changeHandler('level', value)}>
                                                            <Select.Option className=' text-gray-200 hover:bg-white text-xs' value="" disabled >Select Level</Select.Option>
