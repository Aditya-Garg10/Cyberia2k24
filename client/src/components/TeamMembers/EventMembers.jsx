...
function EventMemebers({ membersDetail }) {
    ...
    const card = heads.map((head, idx) => {
      ...
      return (
        <div key={idx}>
          <div className="py-4 my-8 grid gap-2 leading-8 w-fit mx-[5rem] bg-[#ffffff20] p-8 rounded-xl bg-opacity-20 backdrop-blur-lg border border-white border-opacity-30 shadow-sm">
            <img
              src={head.img}
              alt={head.userName}
